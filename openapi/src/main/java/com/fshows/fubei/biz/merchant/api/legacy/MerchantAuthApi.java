...
import com.fshows.fubei.biz.merchant.model.entity.AuthPublicMinaModel;
import com.fshows.fubei.biz.merchant.model.entity.AuthWechatOfficialAccountsModel;
import com.fshows.fubei.biz.merchant.model.param.ParamMinaPublicAuth;
import com.fshows.fubei.biz.merchant.model.param.ParamPaymentAuth;
...
public interface MerchantAuthApi {
    ...
    @FubeiOpenApi(method = "openapi.payment.auth.auth")
