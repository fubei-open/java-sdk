...
import com.fshows.lifecircle.biz.merchant.model.entity.*;
...
public interface MerchantOrderApi {
    ...
    @LifecycleApi(method = "openapi.payment.order.query")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.reconciliation")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.refund")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.refund.query")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.refund.statistics")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.reverse")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.bill")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.close")
