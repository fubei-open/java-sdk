...
public interface MerchantPaymentApi {
    ...
    @LifecycleApi(method = "openapi.payment.order.swipe")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.scan")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.order.h5pay")
     ...
     */
    @POST(OpenApiConstants.GATEWAY)
    @LifecycleApi(method = "openapi.payment.Alipay.H5")
