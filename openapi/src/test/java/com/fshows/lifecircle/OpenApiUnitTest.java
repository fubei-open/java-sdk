package com.fshows.lifecircle;

import com.alibaba.fastjson.JSON;
import com.fshows.lifecircle.biz.merchant.api.legacy.MerchantCommonApi;
import com.fshows.lifecircle.biz.merchant.api.legacy.MerchantOrderApi;
import com.fshows.lifecircle.biz.merchant.api.legacy.MerchantStoreApi;
import com.fshows.lifecircle.biz.merchant.model.BizResult;
import com.fshows.lifecircle.biz.merchant.model.entity.PaymentCloseOrderModel;
import com.fshows.lifecircle.biz.merchant.model.entity.ServerTimeModel;
import com.fshows.lifecircle.biz.merchant.model.param.ParamPaymentOrderClose;
import com.fshows.lifecircle.biz.merchant.model.param.ParamPaymentQueryStore;
import com.fshows.lifecircle.biz.merchant.model.param.ParamQueryStoreCategory;
import com.fshows.lifecircle.foundation.apiproxy.MerchantApiProxy;
...
public class OpenApiUnitTest {
    ...
    public void testRequest() {
        ...
        String sign = com.fshows.lifecircle.test.SignUtil.createSign(map, secret);
        map.put("sign", sign);
    }
